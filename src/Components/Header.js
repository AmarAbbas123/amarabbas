        ...
        <header className="rn-header-area d-flex align-items-start flex-column left-header-style">
          ...
          <nav id="sideNavs" className="mainmenu-nav navbar-example2">
            <ul className="primary-menu nav nav-pills">
              ...
              <li className="nav-item">
                <a
                  className="nav-link smoth-animation-two active"
                  href="#about"
                >
                  <i data-feather="home"></i> About Me
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link smoth-animation-two" href="#features">
                  {" "}
                  <i data-feather="briefcase"></i>Speciality
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link smoth-animation-two" href="#portfolio">
                  <i data-feather="layers"></i>Portfolio
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link smoth-animation-two" href="#resume">
            ...
            <div className="social-share-style-1">
              ...
              <ul className="social-share d-flex liststyle">
                <li className="facebook">
                  <a href="https://web.facebook.com/amar.abbas.503645">
                    <svg
                ...
                <li className="instagram">
                  <a href="https://www.instagram.com/amarabbas1294/?hl=en">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <li className="linkedin">
                  <a
                    href="linkedin.com/in/amar-abbas
"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="content">
            ...
            <div className="social-share-style-1 mt--40">
              ...
              <ul className="social-share d-flex liststyle">
                ...
                <li className="linkedin">
                  <a href="linkedin.com/in/amar-abbas">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
